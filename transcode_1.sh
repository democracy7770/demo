...
-s 1280x720 -c:v libx264 -c:a aac -b:v 2.5M -r 15 -y ${OUTPUT_DIR}/${OUTPUT_FILE_PREFIX_NAME}_720p15fps.mp4 \
-s 1920x1080 -c:v libx264 -c:a aac -b:v 4M -r 15 -y ${OUTPUT_DIR}/${OUTPUT_FILE_PREFIX_NAME}_1080p15fps.mp4 \
-s 2560x1440 -c:v libx264 -c:a aac -b:v 6M -r 15 -y ${OUTPUT_DIR}/${OUTPUT_FILE_PREFIX_NAME}_1440p15fps.mp4 \
-s 3840x2160 -c:v libx264 -c:a aac -b:v 8M -r 15 -y ${OUTPUT_DIR}/${OUTPUT_FILE_PREFIX_NAME}_4k15fps.mp4"
